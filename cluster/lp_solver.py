...
def generate_labels_min_mlu(input_pkl, output_label_pkl, capacity, k=8, smoothing=0.1):
    ...
    for ts_idx, data in enumerate(dataset):
        ...
        # =====================================================================
        # 修复点 2：在约束挂载时，同样采用步进为 2 的方式映射流量
        # =====================================================================
...
if __name__ == "__main__":
    ...
    labels = generate_labels_min_mlu(input_data_pkl, output_label_pkl, capacity=2500, k=8, smoothing=0.1)
